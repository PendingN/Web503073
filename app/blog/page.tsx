    ...
    <main>
      ...
      <section className="featured-post" aria-labelledby="featured-title">
        ...
        <div className="featured-copy">
          ...
          <Link href="/dashboard#collections" className="blog-read-link">Đọc câu chuyện <span aria-hidden="true">→</span></Link>
        </div>
      </section>
        ...
        <div className="post-grid">
          {posts.map(post => <article className="post-card" key={post.title}>
            ...
            <div className="post-card-body">
              ...
              <div className="post-card-foot"><span>{post.time}</span><Link href="/dashboard#collections" aria-label={`Đọc bài ${post.title}`}>Đọc bài →</Link></div>
            </div>
          </article>)}
        </div>
      </section>
